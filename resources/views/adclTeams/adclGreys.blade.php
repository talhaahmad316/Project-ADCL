...
@section('title') {{'ADCL Greys'}} @endsection
...
<div style="margin-top: 14%;">
    ...
    <div class="text">
        <img src="images/greycms.jpg" style="width: 100%; height:350px;" alt="">
        <div class="centered">ADCL Greys</div>
    </div><br><hr>
    <h2 style="text-align: center; color: grey; font-size: 44px; font-weight: bolder;"> Greys Players Pool: {{ $players->total() }}</h2><hr>
            ...
            <div class="col-md-3 mb-4"> <!-- Adjust column size to col-md-3 -->
                <div class="team-column style-2" style="margin-bottom: 20px;"> <!-- Add margin-bottom style -->
                    ...
                    <div class="player-name">
                        <div class="desination-2" style="background-color:grey; font-family:Roboto; ">ADCL Greys</div>
                        <h5 style="font-family:Roboto;">{{ $player->name }}</h5>
                        <span class="player-number" style="background-color:grey; font-family:Roboto;"> {{ $player->description }}</span>
                    </div>
                </div>
            </div>
        @endforeach
