...
@section('body')
<div class="container-fluid" style="margin-left: -20px; width:102.6%; font-family: oswald; font-size:18px; background-color:white;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="matchNo" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
