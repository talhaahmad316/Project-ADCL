...
<div class="container-fluid" style="margin-left: -5px; width:102%; font-family: oswald; font-size:18px; background-color:white;">
    <h2>Add Player</h2>
    @if(session('success'))
    ...
    <form action="{{ route('players.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" name="Picture" accept="image/*" class="form-control-file" required onchange="previewImage(event)">
