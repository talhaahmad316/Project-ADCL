...
@section('body')
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <select class="form-control" name="club_countary">
                                ...
                                <option value="United Club Limited"{{ ($club->club_countary=='United Club Limited')?'selected':'' }}>United Club Limited</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="personal_club" class="form-control" required>
                            <option value="">Select Countary Club</option>
                            <option value="ADCL"{{ ($club->personal_club=='ADCL')?'selected':'' }}>ADCL</option>
                        </select>
                    </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="submit" class="btn btn-primary" style="margin-left: 90%;">Update Club</button>
        </div><br>
    </div>
    </form>
    <br>
